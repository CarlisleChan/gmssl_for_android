...
Java_com_example_gmssl_Crypto_aesEnc(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length,
                                     jbyteArray key_) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_aesDec(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length,
                                     jbyteArray key_) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sha1(JNIEnv *env,
                                   jobject instance,
                                   jbyteArray in_,
                                   jint length) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
...
Java_com_example_gmssl_Crypto_genSM2KeyPairs(JNIEnv *env,
                                             jobject instance,
                                             jstring path_) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm3(JNIEnv *env,
                                  jobject instance,
                                  jbyteArray in_,
                                  jint length) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm4Enc(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length,
                                     jbyteArray key_) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm4Dec(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length,
                                     jbyteArray key_) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm2Enc(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm2Dec(JNIEnv *env,
                                     jobject instance,
                                     jbyteArray in_,
                                     jint length) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_example_gmssl_Crypto_sm2Sign(JNIEnv *env,
                                      jobject instance,
                                      jbyteArray in_,
                                      jint length) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
    ...
    memset(z, 0, zlen + 1);
    iret = SM2_compute_message_digest(EVP_sm3(), EVP_sm3(), (const unsigned char *) in, length,
                                      SM2_DEFAULT_ID_GMT09, SM2_DEFAULT_ID_LENGTH, z, &zlen,
                                      ec_key);
    if (!iret) {
        return NULL;
    }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_gmssl_Crypto_sm2Verify(JNIEnv *env, jobject instance, jbyteArray in_,
                                        jint length, jbyteArray sign_, jint signLen) {
    jbyte *in = env->GetByteArrayElements(in_, NULL);
    ...
    size_t zlen = 0;
    iret = SM2_compute_message_digest(EVP_sm3(), EVP_sm3(), (const unsigned char *) in, length,
                                      SM2_DEFAULT_ID_GMT09, SM2_DEFAULT_ID_LENGTH, NULL, &zlen,
                                      ec_key);
